...
const Pricing = () => {
    return (
        ...
        <div className="">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center p-4 md:py-5 lg:py-7 gap-6 md:gap-8 lg:gap-10 lg:px-8">




                <div className="border md:hover:scale-105 lg:hover:scale-105 duration-500 border-sky-700 rounded-2xl shadow-2xl w-[300px] sm:w-[500px] md:w-[330px] lg:w-[320px] xl:w-[400px] bg-white dark:bg-gray-800 p-4">
                    ...
                    <button type="button" className="py-2 px-4  bg-sky-600 hover:bg-sky-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                        Choose plan
                    </button>
                </div>
                ...
                <div className="border md:hover:scale-105 lg:hover:scale-105 duration-500 border-sky-700 rounded-2xl shadow-2xl w-[300px] sm:w-[500px] md:w-[330px] lg:w-[320px] xl:w-[400px] bg-indigo-500 dark:bg-gray-800 p-4">
                    ...
                    <button type="button" className="w-full px-3 py-3 text-sm shadow rounded-lg text-indigo-500 bg-white hover:bg-gray-100 font-bold">
                        Choose plan
                    </button>
                </div>
