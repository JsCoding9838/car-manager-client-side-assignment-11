    ...
    return (
        ...
        <div className="">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-5 py-4 md:gap-10 md:py-10  md:px-12 lg:py-12 lg:px-20">
                ...
                <div class="border md:hover:scale-105 lg:hover:scale-105 duration-500 border-sky-700 rounded-2xl shadow-2xl w-[90%] sm:w-[80%] md:w-[300px] lg:w-[280px] bg-white dark:bg-gray-800 p-4">
                    ...
                    <button type="button" class="py-2 px-4  bg-sky-600 hover:bg-sky-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                        Choose plan
                    </button>
                </div>
                ...
                <div class="border md:hover:scale-105 lg:hover:scale-105 duration-500 border-sky-700 rounded-2xl shadow-2xl w-[90%] sm:w-[80%] md:w-[300px] lg:w-[280px] bg-indigo-500 dark:bg-gray-800 p-4">
                    ...
                    <ul class="text-sm text-white w-full mt-6 mb-6">
                        ...
                        <li class="mb-3 flex items-center opacity-50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" class="h-6 w-6 mr-2" fill="white" viewBox="0 0 1792 1792">
                                <path d="M1277 1122q0-26-19-45l-181-181 181-181q19-19 19-45 0-27-19-46l-90-90q-19-19-46-19-26 0-45 19l-181 181-181-181q-19-19-45-19-27 0-46 19l-90 90q-19 19-19 46 0 26 19 45l181 181-181 181q-19 19-19 45 0 27 19 46l90 90q19 19 46 19 26 0 45-19l181-181 181 181q19 19 45 19 27 0 46-19l90-90q19-19 19-46zm387-226q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z">
                                </path>
                            </svg>
                            Prenium svg
                    ...
                    <button type="button" class="w-full px-3 py-3 text-sm shadow rounded-lg text-indigo-500 bg-white hover:bg-gray-100 font-bold">
                        Choose plan
                    </button>
                </div>
