...
const Register = () => {
    const {getEmail,getPassword, getRepeatPassword} = useFirebase()
    return (
        <>
...
<label for="terms" className="ml-2 text-[13px] font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="/" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
</div>
<div>
