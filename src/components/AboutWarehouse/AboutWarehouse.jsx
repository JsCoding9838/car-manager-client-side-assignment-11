...
const AboutWarehouse = () => {
    return (
        ...
        <div href="/" className="flex flex-col items-center md:gap-x-6 lg:gap-12 justify-evenly bg-white rounded-lg mx-auto shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
