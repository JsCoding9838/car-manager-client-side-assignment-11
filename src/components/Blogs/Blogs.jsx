...
const Blogs = () => {
    return (
        <div className=''>
            <div className='border border-red-700 text-center my-2 py-2 lg:mt-6'>
                <h3 className='text-[22px] md:text-3xl lg:text-5xl font-bold'>Frequently Asked Questions</h3>
            </div>
            
            <div className='border border-green-600 grid md:grid-cols-2 grid-cols-1 justify-center items-center gap-2 p-2 md:gap-6 md:p-6 lg:gap-12 lg:p-12'>

                <div className="flex justify-center border border-red-700 h-[520px]">
                    <div className="block rounded-lg shadow-lg bg-white">
                        <div className="py-3 border-b border-gray-300 font-semibold text-center text-[18px]">
