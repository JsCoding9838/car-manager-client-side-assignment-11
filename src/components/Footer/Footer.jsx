...
const Footer = () => {
    ...
    <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between text-center">
        <span class="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com">Flowbite™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0 justify-center">
