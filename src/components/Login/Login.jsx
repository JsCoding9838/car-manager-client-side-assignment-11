...
const Login = () => {
  const {getEmail,getPassword,logInUser,signInGoogle,resetPassword} = useFirebase()
  ...
  return (
    <div className="flex justify-center mt-20 md:mt-28 lg:mt-44">
      <form onSubmit={logInUser} className="w-[90%] md:w-[450px] lg:w-[600px] border-2 px-4 py-10 rounded">
        <div className="mb-6">
          <div onClick={signInGoogle}   className="shadow-sm cursor-pointer text-center bg-[#4285F4] border border-gray-300 text-white  rounded-full   block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600  dark:text-white  dark:shadow-sm-light" >
        ...
        <Link to='/reset-password' className="text-blue-600 hover:underline dark:text-blue-500 " >Forget Password</Link>
