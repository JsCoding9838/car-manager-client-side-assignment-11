                ...
                {inventorys.slice(0,6).map(inventory => <div key={inventory.id}> 
                    <div className="md:hover:scale-105 lg:hover:scale-105 max-w-full bg-white rounded-2xl border border-gray-300 hover:border-sky-500 duration-500 shadow-2xl  dark:bg-gray-800 dark:border-gray-700 sm:mx-6 md:w-[330px] lg:w-[280px]">
                        ...
                        <div className="p-5">
                            ...
                            <a href="/" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-sky-500 rounded-lg hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:translate-x-1 duration-500">
                            Manage Stock
